...
export const inventory: InventoryItem[] = [
  ...
  { id: 'ITEM-005', sku: 'GPS-MOD-2', name: 'Módulo GPS v2', imageUrl: 'https://placehold.co/100x100.png', quantity: 12, minThreshold: 15, unitCost: 120, unit: 'ud', supplier: 'Global Nav', type: 'simple' },
  { id: 'ITEM-006', sku: 'CAM-SEC-HD', name: 'Cámara de Seguridad HD', imageUrl: 'https://placehold.co/100x100.png', quantity: 30, minThreshold: 10, unitCost: 85, unit: 'ud', supplier: 'TechParts Inc.', type: 'simple' },
  { id: 'ITEM-007', sku: 'CBL-PWR-10M', name: 'Cable de Alimentación 2-hilos', imageUrl: 'https://placehold.co/100x100.png', quantity: 150, minThreshold: 50, unitCost: 2.5, unit: 'ml', supplier: 'TechParts Inc.', type: 'simple' },
